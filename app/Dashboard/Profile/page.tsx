    ...
    return (
        <div className='surface-0'>
            <div className='container vh-100 flex items-center justify-center sm:w-full'>
                    <div id='box' className=" p-5 shadow-2 border-round bg-light w-full sm:w-6">
                        <div className="row g-2 mb-3 ps-0">
                            <div className="col-3 position-relative d-inline-block me-2 ">
                                ...
                                <LuPencilLine className="position-absolute shadow" style={{ fontSize: '25px', color: '#000', top: '75%', left: '70%', background: '#F5F7F8', transform: 'translate(-50%, -50%)', borderRadius: '50%', padding: '3px' }} />
                            </div>
                            <div className="col-6">
                                <p>Your Name</p>
